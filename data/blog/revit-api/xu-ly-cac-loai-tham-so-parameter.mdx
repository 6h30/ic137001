---
title: 'Xử lý các loại tham số (Parameters)'
date: 2025-04-15T15:32:14Z
lastmod: '2025-04-15'
tags: ['revit-api', 'parameters', 'guide']
draft: false
summary: 'Trong Revit, Parameters (tham số) là cơ sở của dữ liệu BIM, chứa đựng mọi thông tin từ kích thước hình học đến các thuộc tính vật liệu hay dữ liệu quản lý dự án. Với Revit API, việc đọc, ghi và thao tác với các Parameters là một trong những tác vụ cơ bản và thường xuyên nhất.'
layout: PostSimple
---
...
### Kiểm tra khả năng đọc/ghi của Parameter (`IsReadOnly` / `IsReadWrite`)
